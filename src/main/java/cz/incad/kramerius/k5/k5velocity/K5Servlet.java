 ...
 * @author alberto
 */
public class K5Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Velocity.setApplicationAttribute("javax.servlet.ServletContext", getServletContext());
            Velocity.init(propFile);
            VelocityContext context = new VelocityContext();
            context.put( "date", new org.apache.velocity.tools.generic.DateTool() );

            Template template = null;
            template = Velocity.getTemplate("/home/home.vm");
