...
ChangePswd.prototype.changePassword  = function () {
	...
	var url = "inc/admin/_change_pswd.vm";
    $.get(url, bind(function(data) {
                ...
                buttons: [
                    {
                        ...
                        click: bind(function() {
                        	if ($("#pswd").val() == $("#pswdRepeat").val()) {
                            	...
                            	$("#checkPswdStatus").css('color','red');
                                $("#checkPswdStatus").text('rights.changepswd.notsamepswd');
                            }                        	
                        },this)
                    },
                    {
    	...
    	$("#changePswd").dialog('option','title','rights.changepswd.title');
    },this));
}
